...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bingwa Sokoni — Automated Offers" },
      { name: "description", content: "Buy Bingwa Sokoni data, SMS, minutes and Tunukiwa offers." },
      { name: "theme-color", content: "#123d2c" },
      { property: "og:title", content: "Bingwa Sokoni — Automated Offers" },
      {
        property: "og:description",
        content: "Buy Bingwa Sokoni data, SMS, minutes and Tunukiwa offers.",
      },
